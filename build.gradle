...
dependencies {
    ...
    compile("org.grails.plugins:events"){
        exclude(module: 'org.grails:grails-core:3.2.11')
        exclude(module: 'org.slf4j:slf4j-api:1.7.22')
        exclude(module: 'org.codehaus.groovy:groovy:2.4.11')
    }

    compile('org.grails.plugins:spring-security-core:3.2.0.M1') {
        exclude(module: 'org.springframework.security:spring-security-core:4.1.0.RELEASE')
        exclude(module: 'org.springframework.security:spring-security-web:4.1.0.RELEASE')
    ...
    compile ('org.hibernate:hibernate-ehcache:5.1.5.Final') {
        exclude(module: 'org.jboss.logging:jboss-logging:3.3.0.Final')
        exclude(module: 'org.hibernate:hibernate-core:5.1.5.Final')
        exclude(module:'net.sf.ehcache:ehcache:2.10.1')
    }
}
